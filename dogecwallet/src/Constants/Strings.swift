...
enum S {
    ...
    enum TransactionDetails {
        ...
        static let txHashHeader = NSLocalizedString("TransactionDetails.txHashHeader", value:"DogeCash Transaction ID", comment: "Transaction ID header")
    ...
    enum About {
        ...
        static let footer = NSLocalizedString("About.footer", value:"Made by the Dogecash community. Version %1$@", comment: "About screen footer")
    }
    ...
    enum MenuButton {
        ...
        static let addressbook = NSLocalizedString("MenuButton.addressbook", value:"Address Book", comment: "Address book title")
    }
